...
const call9295Button = getButton("call9295");
const call92030Button = getButton("call92030");
const call9296Button = getButton("call9296");
const call9297Button = getButton("call9297");
const call9298Button = getButton("call9298");
const call9299Button = getButton("call9299");
...
const disableAllCallButtons = (): void => {
  ...
  call9201Button.disabled = true;
  call9203Button.disabled = true;
  call9295Button.disabled = true;
  call92030Button.disabled = true;
  call9296Button.disabled = true;
  call9297Button.disabled = true;
  call9298Button.disabled = true;
  call9299Button.disabled = true;
  call9203Button.disabled = true;
  call9295Button.disabled = true;
  call9296Button.disabled = true;
  call9297Button.disabled = true;
...
const simpleUserDelegate: SimpleUserDelegate = {
  ...
  onCallHangup: (): void => {
    ...
    call92030Button.disabled = false;
    ...
    call9201Button.disabled = false;
    call9203Button.disabled = false;
    call9295Button.disabled = false;
    call9296Button.disabled = false;
    call9297Button.disabled = false;
    call9298Button.disabled = false;
    call9299Button.disabled = false;
...
// Add click listener to call 92030 button (Audio AI test)
call92030Button.addEventListener("click", () => placeAudioCall("sip:92030@sip.weiyuai.cn"));

// Add click listeners to new Audio AI test buttons 9295-9299
call9295Button.addEventListener("click", () => placeAudioCall("sip:9295@sip.weiyuai.cn"));
call9296Button.addEventListener("click", () => placeAudioCall("sip:9296@sip.weiyuai.cn"));
call9297Button.addEventListener("click", () => placeAudioCall("sip:9297@sip.weiyuai.cn"));
call9298Button.addEventListener("click", () => placeAudioCall("sip:9298@sip.weiyuai.cn"));
call9299Button.addEventListener("click", () => placeAudioCall("sip:9299@sip.weiyuai.cn"));
